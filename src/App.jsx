  ...
  return (
    <>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 11, fontWeight: 600, color: 'var(--mocha)', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: 10 }}>
          Alle Bereiche
        </div>
            ...
            return (
              <NavLink
                ...
                style={{
                  ...
                  background: isActive ? 'var(--sand)' : '#fff',
                  border: `1px solid ${isActive ? 'var(--taupe)' : 'var(--sand)'}`,
                  color: isActive ? 'var(--espresso)' : 'var(--brown)',
                  transition: 'all .15s',
                }}
              >
      ...
      <nav style={{
        ...
        {NAV_MAIN.map(({ to, icon: Icon, label }) => (
          <NavLink
            ...
            style={({ isActive }) => ({
              ...
              alignItems: 'center', gap: 2, padding: '6px 0 4px',
              textDecoration: 'none',
        ...
        <button
          ...
          style={{
            ...
            color: open || moreActive ? 'var(--terra)' : 'var(--mocha)',
            fontSize: 10, fontWeight: open || moreActive ? 600 : 400,
        ...
        >
          {open
            ...
            : <IconMenu2 size={21} stroke={open || moreActive ? 2 : 1.5} />
          }
          <span>Mehr</span>
        </button>
      </nav>
